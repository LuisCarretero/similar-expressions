...
# Upload the file
run.save("/cephfs/store/gr-mc2473/lc865/workspace/wandb-cache/wandb/latest-run/files/epoch=57.ckpt", base_path="/cephfs/store/gr-mc2473/lc865/workspace/wandb-cache/wandb/latest-run/files/")
